           ...
           @can('قائمة الفواتير')
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                    <div class="pull-left"><i class="ti-calendar"></i><span class="right-nav-text">الفواتير</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">

                    @can('عرض الفواتير')
                    <li> <a href="{{route('invoices.index')}}">قائمة الفواتير</a> </li>
                    @endcan

                   @can('اضافة فاتورة جديدة')
                    <li> <a href="{{route('invoices.create')}}">اضافة فاتورة جديدة</a> </li>
                   @endcan
